...
public static class CollectionsPool
{
    private static class ListPool<T>
    {
        ...
        static ListPool()
        {
            ...
            {
                Pool.Push(new List<T>(1000));
            }
        }

        public static List<T> Get(int capacity = 1000)
        {
    ...
    private static class HashSetPool<T>
    {
        ...
        static HashSetPool()
        {
            for (var i = 0; i < InitialPoolSize; i++)
            {
                Pool.Push(new HashSet<T>(1000));
            }
        }

        public static HashSet<T> Get(int capacity = 1000)
        {
    ...
    public static List<T> GetList<T>(int capacity = 1000)
    {
    ...
    public static HashSet<T> GetHashSet<T>(int capacity = 1000)
    {
